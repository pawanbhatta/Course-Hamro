        ...
        <HStack w={"100%"} alignItems={"flex-start"}>
          <VStack w={"100%"} justifyContent={"flex-start"}>
            ...
            <Text
              ...
              fontWeight={500}
            >
              Hamrocourse stands out due to its affordable pricing,
              comprehensive curriculum, flexible learning options, supportive
              community, and Nepali-centric approach. These unique features make
              it an ideal choice for Nepali students seeking quality education
              in coding and other relevant topics.
            </Text>
            <Text
              w={"100%"}
              className={`${styles.sectionSubText} `}
              ...
              pt={40}
            >
              In addition, Hamrocourse has a dedicated team of experienced
              instructors who provide personalized attention and support,
              helping students develop coding skills and reach their full
              potential. Combined with its unique features, Hamrocourse is an
              excellent choice for anyone looking to learn coding and related
              skills online.
            </Text>
